...
def api_call(method: str, url: str, **kwargs):
    ...
    def _show_error_popup(message):
        """Show error messasge as a popup in the top-right corner."""
...
if prompt := st.chat_input("How can I assist you today?"):
    ...
    with st.chat_message("assistant"):
        output = api_call(
            ...
            json={"provider": st.session_state.provider, "model_name": st.session_state.model_name, "messages": st.session_state.messages}
        )
